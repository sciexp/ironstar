...
- Lit component bundling: `lit-component-bundling.md` (Rolldown vs esbuild, TypeScript decorators, tree-shaking ECharts)
...
- Open Props tokens: see the Open Props section in `../core/architecture-decisions.md`
- Open Props UI components: see the Open Props UI section in `../core/architecture-decisions.md`
- Rolldown bundler: see the Rolldown section in `../core/architecture-decisions.md`
- Lucide icons: see the Lucide section in `../core/architecture-decisions.md`
