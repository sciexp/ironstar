...
| Lit | Complex third-party lib wrappers | Essential for libraries with lifecycle requirements (ECharts, Vega-Lite). Light DOM for CSS token inheritance. See `../frontend/ds-echarts-integration-guide.md` for canonical pattern. |
...
See `../frontend/ds-echarts-integration-guide.md` for the complete ECharts integration pattern, including Datastar signal binding and SSE-driven chart updates.
...
See `../frontend/signal-contracts.md` for detailed integration patterns.
