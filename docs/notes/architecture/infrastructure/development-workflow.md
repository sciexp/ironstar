...
For detailed implementation patterns including conditional compilation and cache headers, see `../frontend/frontend-build-pipeline.md` section "Asset serving patterns".
...
<details>
<summary>Full SVG/PNG workflow reference</summary>
...
- Asset embedding decision: `../core/architecture-decisions.md`
- Signal type contracts: `../frontend/signal-contracts.md`
- Frontend build pipeline: `../frontend/frontend-build-pipeline.md`
