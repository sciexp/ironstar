...
> See [semantic-model.md § Catamorphism](../core/semantic-model.md#state-reconstruction-as-catamorphism) and [§ Galois connection](../core/semantic-model.md#projections-as-galois-connection).
