...
For the initial single-node event bus design, see `infrastructure-decisions.md`.
...
- SSE connection lifecycle: `sse-connection-lifecycle.md` (subscription patterns)
