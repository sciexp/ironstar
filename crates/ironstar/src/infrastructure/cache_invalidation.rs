...
use crate::infrastructure::cached_analytics::CachedAnalyticsService;
use crate::infrastructure::key_expr::ALL_EVENTS;
...
mod tests {
    ...
    async fn spawn_invalidation_processes_events() {
        use crate::infrastructure::event_bus::open_embedded_session;
