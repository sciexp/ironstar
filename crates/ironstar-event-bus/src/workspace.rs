...
use crate::cache_dependency::CacheDependency;
use crate::error::EventBusError;
use crate::key_expr::aggregate_type_pattern;
use std::sync::Arc;
use zenoh::Session;
...
impl WorkspaceSubscriberFactory {
    ...
    pub async fn subscribe_workspace(&self) -> Result<ZenohSubscriber, EventBusError> {
    ...
    pub async fn subscribe_dashboard(&self) -> Result<ZenohSubscriber, EventBusError> {
    ...
    pub async fn subscribe_saved_query(&self) -> Result<ZenohSubscriber, EventBusError> {
    ...
    pub async fn subscribe_user_preferences(&self) -> Result<ZenohSubscriber, EventBusError> {
    ...
    pub async fn subscribe_all(
        &self,
    ) -> Result<Vec<(&'static str, ZenohSubscriber)>, EventBusError> {
...
mod tests {
    use super::*;
    use crate::event_bus::{EventBus, ZenohEventBus, open_embedded_session};
    ...
    async fn subscriber_factory_creates_workspace_subscriber() {
        ...
        EventBus::publish(&event_bus, &event)
            .await
    ...
    async fn subscriber_factory_filters_by_aggregate_type() {
        ...
        EventBus::publish(&event_bus, &ws_event)
            .await
            .expect("publish should succeed");
        ...
        EventBus::publish(&event_bus, &db_event)
            .await
            .expect("publish should succeed");
