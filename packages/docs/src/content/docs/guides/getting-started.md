...
description: Quick start guide for using ironstar
---
...
1. **Read contributing guidelines** - See [CONTRIBUTING.md](https://github.com/sciexp/ironstar/blob/main/CONTRIBUTING.md)
...
- [GitHub Discussions](https://github.com/sciexp/ironstar/discussions) - Ask questions
- [GitHub Issues](https://github.com/sciexp/ironstar/issues) - Report bugs or request features
