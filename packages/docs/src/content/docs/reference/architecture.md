...
description: Key architectural decisions and rationale for ironstar
---
...
See [CONTRIBUTING.md](https://github.com/sciexp/ironstar/blob/main/CONTRIBUTING.md) for detailed conventional commit guidelines.
...
- Package name is `@ironstar/docs` not `@ironstar/starlight`
