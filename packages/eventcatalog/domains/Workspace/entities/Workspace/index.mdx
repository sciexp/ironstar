...
- `TransferOwnership`: Assigns a new owner to the workspace
...
- `WorkspaceOwnershipTransferred`: Owner changed
...
- **TransferOwnership(new_owner_id)** when workspace exists:
...
- **WorkspaceOwnershipTransferred(new_owner_id, _)**:
